...
class GoogleLoginComponent extends Component {
    constructor() {
        super();
        this.state = {
            isProcessingSocialLogin: false,
        }
    }
    responseGoogle = (response) => {
        this.setState({isProcessingSocialLogin: true})
        store.dispatch(() => loginWithGoogle(response, 'google'));
    }
    ...
    render() {
        return (
            <div>
                {
                    this.state.isProcessingSocialLogin === true ?
                        (
                ...
                <div className="row mt-4">
                    <div className="col-md-8 offset-md-2 text-center">
                        <GoogleLogin
                            clientId="904291153140-epe4kgl1b6bfjvrbf9rl4kdcndc8rr0a.apps.googleusercontent.com"
