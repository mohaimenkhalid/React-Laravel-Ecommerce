                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center" id="headingOne">
                                ...
                                <a href="{{ route('admin.category.edit', $category->id) }}" class="btn btn-primary btn-sm text-white">Edit</a>
                            </div>
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                <div class="card">
                                                    <div class="card-header d-flex justify-content-between align-items-center" id="headingOne">
                                                        ...
                                                        <a href="{{ route('admin.category.edit', $subcategory->id) }}" class="btn btn-primary btn-sm text-white">Edit</a>
                                                    </div>
                                                                    ...
                                                                    <div class="accordion" id="accordionExample">
                                                                        <div class="card">
                                                                            <div class="card-header d-flex justify-content-between align-items-center" id="headingOne">
                                                                                ...
                                                                                <a href="{{ route('admin.category.edit', $subsubcategory->id) }}" class="btn btn-primary btn-sm text-white">Edit</a>
                                                                            </div>
